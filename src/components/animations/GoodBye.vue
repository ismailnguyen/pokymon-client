        ...
        <div class="content center">
            <h1 id="master">
              ...
              <div id="master-container-scroller">
                ...
                <div class="master-container-scroller_item">Felix</div>
              </div>
              <div>It was a pleasure to work with you ! See you again <small>(very soon)</small> ❤️ </div>
            </h1>
        </div>
    </div>
</template>
...
<script>
	export default {
        ...
        computed: {
            name: function () {
                return this.$route.params.id.split('goodbye-')[1]
            }
        }
    }
